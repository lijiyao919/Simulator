...
FILE_NAME = "Taxi_Trips_Chicago_7AM_to_11AM_09_17_2019.csv"
CLEAN_FILE_NAME = "Taxi_Trips_Chicago_7AM_to_11AM_09_17_2019_clean.csv"
YEAR = 2019
MONTH = 9
DATE = 17
...
def clean_trips_data():
    ...
    for i in range(len(df)):
        ...
        #time
        timestamp = int((pd.to_datetime(obs["Trip Start Timestamp"]) - pd.Timestamp(YEAR, MONTH, DATE, 7)) / pd.to_timedelta(1, unit='m'))
