...
class Agent(object):
    ...
    @classmethod
    def get_state_dist(cls, demand_dist, supply_dist):
        ...
        return s_dist, d_dist

    @classmethod
    def get_state_zid(cls, zone_id):
        zone_code = np.array(cls._one_hot_encode(zone_id - 1, 77))  # id 1, endcode as 0 here [1,0,0,0,....]
        return zone_code
    ...
    def get_next_state_dist(cls, driver, demand_dist, supply_dist):
        if driver.in_service:
            ...
            s_dist, d_dist = cls.get_state_dist(demand_dist, supply_dist)
            zone_code = cls.get_state_zid(driver.zid)
            return s_dist, d_dist, zone_code
